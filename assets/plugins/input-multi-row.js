(function($)
{
  ...
  $.fn.inputMultiRow = function(options) 
  {
    ...
    var tb = 
  '<button type="button" class="btn btn-info pull-right btnplus_'+nama+'"><i class ="fa fa-plus"></i></button><table class="table tb_'+nama+'" style="width:100%"><thead></thead><tbody></tbody></table';
    this.html(tb);
    var header = "<tr>";
    // options.column();
