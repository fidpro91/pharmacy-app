...
class CI_Datascript 
{
	...
	public function default_library()
	{
		...
		$this->css .= '<link rel="stylesheet" href="'.$this->folder_css.'plugins/jquery-ui-1.13.1/jquery-ui.min.css">'."\n";
		...
		$this->js .= '<script src="'.$this->folder_js.'plugins/jquery-ui-1.13.1/jquery-ui.min.js"></script>'."\n";
