    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Form Ms Unit</h3>
          <div class="box-tools pull-right">
            <button type="button" id="btn-add" class="btn btn-primary">
              <i class="fa fa-plus"></i> Add</button>
          </div>
        </div>
        <div class="box-body" id="form_ms_unit" style="display: none;">
        </div>
        <div class="box-body" id="data_ms_unit">
          <?=create_table("tb_ms_unit","M_ms_unit",["class"=>"table table-bordered" ,"style" => "width:100% !important;"])?>
        </div>
