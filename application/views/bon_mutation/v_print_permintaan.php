	    ...
	    <table width="100%" border="0" cellpadding="1" cellspacing="0">
	        <tr>
	            ...
	            <td valign="center" align="left">
	                <h3><?= $data['hsp_name'] ?></h3>
	                <!-- <small><?= ucfirst($data['hsp_address']) . ' Kecamatan ' . ucfirst($data['hsp_distrik']) . ' ' . ucfirst($data['hsp_city']) . ' Provinsi ' . ucfirst($data['hsp_prov']) ?>
	                    <br>
	                    Email / Phone : <?= $data['hsp_email'] . ' / ' . $data['hsp_phone'] ?>
	                    <br>
	                    Website : <?= $data['hsp_website'] ?>
	                </small> -->
	                <small><?= ucfirst($data['hsp_address']) . ' ' . ucfirst($data['hsp_city']) . ' Provinsi ' . ucfirst($data['hsp_prov']) ?>
	                    <br>
	                    Email / Phone : <?= $data['hsp_email'] . ' / ' . $data['hsp_phone'] ?>
	                    <br>
	                    Website : <?= $data['hsp_website'] ?>
	        ...
	        <table style="text-align:center" border="0" width="100%">
	            <tr>
	                <td colspan="2" align="center" height="">
	                    <h3 style="font-size:12px">DAFTAR PERMINTAAN OBAT DARI <?php echo strtoupper($row->asal); ?></h3>
	                </td>
	            </tr>
	            <tr>
