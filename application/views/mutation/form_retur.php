<div class="col-md-12">
<?= form_open(site_url("mutation/save"), ["method" => "post", "class" => "form-horizontal", "id" => "fm_mutation"], $model) ?>
<?= form_hidden("mutation_id") ?>
<?= form_hidden("unit_require",55) ?>
...
<?= create_select2([
    "attr" => ["name" => "unit_sender=Unit Pengirim", "id" => "unit_sender", "class" => "form-control"],
    "model" => [
    ...
    $(".list_item").inputMultiRow({
        column: () => {
            ...
            $.ajax({
                ...
                'type': "GET",
                'dataType': 'json',
                'url': "<?=site_url()?>mutation/show_multiRows",
